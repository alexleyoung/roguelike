...
game: main.c $(wildcard gen/*.c) $(wildcard dsa/*.c) $(wildcard saves/*.c) $(wildcard monsters/*.c) # compile source files to game
	gcc main.c gen/*.c dsa/*.c saves/*.c monsters/*.c -Igen -Idsa -Isaves -Imonsters -o game
